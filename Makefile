...
# Generated by qmake (2.01a) (Qt 4.8.4) on: ?? ??? 30 18:02:30 2012
# Project:  project.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe -o Makefile project.pro
#############################################################################
...
Makefile: project.pro  c:\Qt\4.8.4\mkspecs\default\qmake.conf c:\Qt\4.8.4\mkspecs\qconfig.pri \
...
clean: debug-clean release-clean FORCE
	-$(DEL_FILE) ".\project.intermediate.manifest"
